...
const TOOL_DEFINITIONS = [
  ...
  },
  {
    ...
    inputSchema: {
      type: 'object',
      properties: {
        category: { type: 'string', description: 'Category slug (e.g., "llm", "ai-coding", "crm"). Use list_categories to get all valid slugs.' },
        sort_by: { type: 'string', description: 'Sort field: "rating" (default, highest rated first) or "startingPrice" (lowest price first)' },
        free_only: { type: 'boolean', description: 'If true, return only tools that offer a free plan (default: false)' },
      },
      required: ['category'],
    },
  },
